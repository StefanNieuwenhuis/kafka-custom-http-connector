package com.nhswd.kafka.custom.http.connector.config;
...
public class HttpSourceConfig extends AbstractConfig {
    ...
    public static final String HTTP_EVENT_TYPES = "http.event.types";
        ...
        return new ConfigDef()
                ...
                .define(HTTP_POLL_INTERVAL_MS,
                        ...
                        "Polling interval in milliseconds between consecutive HTTP requests. " +
                                "Minimum allowed is 5000 ms (10 seconds). Default is 60000 ms (1 minute).")
                .define(HTTP_METHOD,
                        ConfigDef.Type.STRING,
                        "GET",
                        ...
                        HTTP_METHOD)
                .define(HTTP_EVENT_TYPES,
                        ConfigDef.Type.LIST,
                        Collections.emptyList(),
                        ConfigDef.Importance.MEDIUM,
                        "Comma-separated list of GitHub event types to ingest, e.g., WatchEvent, PullRequestEvent, IssuesEvent." +
                                "EMPTY list = all events are allowed."
                )
